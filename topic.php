...
if(isset($_GET['limit']))
{
    ...
    if($plus>=125)
    {echo'<a class="plus" href="topic.php?sujet='.$_GET['sujet'].'&limit=tout">Afficher tous les messages</a><br/>';}
    else{$plus+=30;
    echo'<a class="plus" href="topic.php?sujet='.$_GET['sujet'].'&limit='.$plus.'">Afficher plus de messges</a><br/>';}
    }
}
 else 
{
    echo'<a class="plus" href="topic.php?sujet='.$_GET['sujet'].'&limit=35">Afficher plus de messages</a><br/>';
}
}
?> 
</div>
